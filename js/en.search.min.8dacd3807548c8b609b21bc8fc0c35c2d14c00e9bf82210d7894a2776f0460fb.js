...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/js/flexsearch-ad47a5e1ee.min.js');loadScript('/js/en.search-data.min.a5ce2feff326c5c393a478d95977ed3e2d29f776a3abbdf40129d7949b14dd94.js',function(){input.required=false;search();});loadScript('/js/groupBy-62b30ac391.min.js');}
